// DUPLA: CLARISSE DINIZ E EDSON LIMA
...
function editarLinha(row) {
  ...
  row.innerHTML = `
    ...
    <td><input type="tel" value="${phone}" required maxlength="11" minlength="10"></td>
  ...
  cancelButton.addEventListener('click', function() {
    cancelarEdicao(row, name, phone, email);
  });
}
...
function cancelarEdicao(row, name, phone, email) {
...
function deletarLinha(row) {
  var tabela = document.getElementById('contact-table');
  tabela.deletarLinha(row.rowIndex);
}
